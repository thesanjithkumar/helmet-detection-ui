...
const Navbar: FC = () => {
  ...
  return (
    <>
      <nav className="flex items-center flex-wrap bg-mineShaft p-3">
        ...
        >
          <div className="lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto w-full lg:items-center items-start  flex flex-col lg:h-auto">
            {/* <Link
              href="/project"
              className={`${s.strike} lg:inline-flex text-xl lg:w-auto w-full px-3 py-2 rounded text-white font-bold items-center justify-center`}
              onClick={handleClick}
            >
              .project()
            </Link> */}
